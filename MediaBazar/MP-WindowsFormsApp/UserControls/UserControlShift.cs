...
namespace MP_WindowsFormsApp.UserControls
{
	public partial class UserControlShift : UserControl
	{
		...
		private ShiftManagement form;
        public int shiftNo { get; set; }
        public string day { get; set; }
        public int shiftDemand { get; set; }
		public List<Shift> shifts { get; set; }

		public UserControlShift(DateTime dateTime, List<Shift> shifts , ShiftManagement form, string day, int shift)
		{
			InitializeComponent();
		...
		private void UserControlShift_Load(object sender, EventArgs e)
		{
			UpdateColor();
		}
